...
map("v", "gcc", "<esc><cmd>lua require('comment.api').toggle.linewise(vim.fn.visualmode())<cr>")
map("n", "gcb", function()
    require("Comment.api").toggle.blockwise.current()
end)
map("v", "gcb", "<esc><cmd>lua require('comment.api').toggle.blockwise(vim.fn.visualmode())<cr>")
